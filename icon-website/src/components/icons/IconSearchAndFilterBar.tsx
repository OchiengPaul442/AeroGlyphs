...
export default function IconSearchAndFilterBar({
  ...
  return (
    <section
      className={`bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 z-40 transition-all duration-300 ${
        isScrolled
          ? "fixed top-[63px] left-0 right-0 shadow-md"
          : "sticky top-16"
      }`}
    >
